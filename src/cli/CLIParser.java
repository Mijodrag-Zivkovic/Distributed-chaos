...
public class CLIParser implements Runnable, Cancellable {
	...
	private Thread drawWorkerThread;
	private DrawWorker drawWorker;
	
	public CLIParser(SimpleServentListener listener) {
		this.commandList = new ArrayList<>();
		this.drawWorker = new DrawWorker();
		drawWorkerThread = new Thread(this.drawWorker);
		commandList.add(new InfoCommand());
		commandList.add(new PauseCommand());
		commandList.add(new StopCommand(this, listener,drawWorker));
		commandList.add(new StartCommand(drawWorkerThread));
